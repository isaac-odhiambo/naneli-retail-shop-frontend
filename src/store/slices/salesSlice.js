...
export const fetchSales = createAsyncThunk(
  ...
  async (_, { getState, rejectWithValue }) => {
    ...
    try {
      const response = await axios.get('https://naneli-backend.onrender.com/sales', {
...
export const recordSale = createAsyncThunk(
  ...
  async (saleData, { rejectWithValue }) => {
    try {
      const response = await axios.post('https://naneli-backend.onrender.com/sales', saleData);
